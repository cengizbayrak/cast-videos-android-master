 ...
 */
@SuppressWarnings({"FieldCanBeLocal", "unused", "ConstantConditions", "SameParameterValue", "deprecation", "ClickableViewAccessibility"})
...
//        mCastContext.registerLifecycleCallbacksBeforeIceCreamSandwich(this, savedInstanceState);
    ...
    private void loadViews() {
        ...
        mTitleView = findViewById(R.id.textView1);
        mDescriptionView = findViewById(R.id.textView2);
        mDescriptionView.setMovementMethod(new ScrollingMovementMethod());
        mAuthorView = findViewById(R.id.textView3);
        ...
        mPlayPause = findViewById(R.id.imageView2);
