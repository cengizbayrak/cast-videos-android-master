 ...
 */
@SuppressWarnings({"unused", "RecyclerView"})
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        static ViewHolder newInstance(View parent) {
            ...
            return new ViewHolder(parent, imgView, textContainer, titleView, descriptionView, aQuery);
        }

        private ViewHolder(View parent, ImageView imgView, View textContainer, TextView titleView, TextView descriptionView, AQuery aQuery) {
            super(parent);
            mParent = parent;
            mImgView = imgView;
        ...
        void setImage(String imgUrl) {
            mAquery.id(mImgView).width(114).image(imgUrl, true, true, 0, R.drawable.default_video, null, 0, mAspectRatio);
        }
    ...
    void setData(List<MediaItem> data) {
        videos = data;
