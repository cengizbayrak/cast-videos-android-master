 ...
 */
@SuppressWarnings({"ConstantConditions", "unchecked", "deprecation", "unused"})
public class VideoBrowserFragment extends Fragment implements VideoListAdapter.ItemClickListener, LoaderManager.LoaderCallbacks<List<MediaItem>> {
