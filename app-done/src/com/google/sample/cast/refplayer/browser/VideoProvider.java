...
@SuppressWarnings({"ConstantConditions", "CharsetObjectCanBeUsed", "unused"})
public class VideoProvider {
    ...
    static List<MediaItem> buildMedia(String url) throws JSONException {
        if (null != mediaList) {
            return mediaList;
        }
    ...
    private static MediaItem buildMediaInfo(String title, String studio, String subTitle, int duration, String url, String mimeType, String imgUrl, String bigImageUrl) {
